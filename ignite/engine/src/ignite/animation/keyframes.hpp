...
#pragma once
#ifndef IGN_KEYFRAMES_HPP
#define IGN_KEYFRAMES_HPP
...
namespace ignite {
    ...
    struct IGN_API TransformKeyFrameBase
    {
    protected:
    ...
    struct IGN_API Vec3Key : TransformKeyFrameBase
    {
    ...
    struct IGN_API QuatKey : public TransformKeyFrameBase
    {
