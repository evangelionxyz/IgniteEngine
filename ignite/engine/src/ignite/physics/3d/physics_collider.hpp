...
namespace ignite::physics
{
	...
	class IGN_API PhysicsBoxCollider : public PhysicsCollider
	{
	public:
	...
	class IGN_API PhysicsSphereCollider : public PhysicsCollider
	{
	public:
	...
	class IGN_API PhysicsCapsuleCollider : public PhysicsCollider
	{
	public:
	...
	class IGN_API PhysicsPlaneCollider : public PhysicsCollider
	{
	public:
	...
	class IGN_API PhysicsMeshCollider : public PhysicsCollider
	{
	public:
