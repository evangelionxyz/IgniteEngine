...
cbuffer PointLightBuffer : register(b4, space0) { PointLight pointLights[MAX_POINT_LIGHTS]; }
cbuffer SpotLightBuffer : register(b5, space0) { SpotLight spotLights[MAX_SPOT_LIGHTS]; }
